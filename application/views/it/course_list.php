    ...
    <div class="wrapper">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
                                <a href="<?php echo base_url('it/course/add')?>" class="btn btn-primary">Add New Course</a>
                                <!-- <button type="button"
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo base_url('it/course/edit/' . $course['Course_id']); ?>">Edit</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item"
        ...
        <script>
            ...
            function viewCourse(id) {
                $.ajax({
                    url: "<?php echo base_url('it/view_course/'); ?>" + id,
                    type: 'GET',
                    dataType: 'json',
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = "<?php echo base_url('it/course/delete/'); ?>" + id;
                    }
                });
            }
